...
public:
    ...
    nsapi_size_or_error_t send(const void* buffer, nsapi_size_t size, SocketAddress sendAddr);
    nsapi_size_or_error_t send(const void* buffer, nsapi_size_t size, const char* addr, uint16_t port);
